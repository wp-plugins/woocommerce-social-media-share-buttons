...
function toastie_wc_smsb_social_init() {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['Submit'])) {
		...
		$smsb_em = sanitize_text_field($_REQUEST['smsb_tu']);
        $smsb_li = sanitize_text_field($_REQUEST['smsb_li']);
		$smsb_em = sanitize_text_field($_REQUEST['smsb_st']);
		...
		update_option('toastie_smsb_em', $smsb_tu);
        update_option('toastie_smsb_li', $smsb_li);
		update_option('toastie_smsb_em', $smsb_st);
    ...
    <div>   
        ...
        <p>Add shortcode to your WordPress theme, or php widget. &lt;?php echo do_shortcode( '[woocommerce_social_media_share_buttons]' ); ?></p>
            <form name="social" method="post" >   
                ...
                <p>&nbsp;</p>
                <p><input type="submit" name="Submit" class="smsb_button" value="Save Settings"></p>
            </form>
